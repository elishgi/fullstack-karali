        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.actionsRow}>
            <TouchableOpacity
              style={[
                styles.actionButton,
                isFilterActive() && styles.actionButtonActive,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  isFilterActive() && styles.actionButtonTextActive,
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                styles.actionButton,
                showGraph && styles.actionButtonActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.actionButtonText,
                  showGraph && styles.actionButtonTextActive,
                ]}
              >
          ...
          <View style={styles.temporaryModalCard}>
            ...
            <View style={styles.modalLogsContainer}>
              {temporaryLogsLoading ? (
                ...
                <ScrollView contentContainerStyle={styles.modalLogsList}>
