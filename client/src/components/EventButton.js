    ...
    >
      <Animated.View style={[styles.eventButtonWrapper, { transform: [{ scale: scaleAnim }] }]}>
        <View style={[styles.eventCard, expired && styles.eventCardExpired]}>
          ...
          {isEditMode && (
            <View style={styles.editButtonsContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={onEditColor}
              >
                <Ionicons name="color-palette-outline" size={16} color="#5E35B1" />
              </TouchableOpacity>
              <TouchableOpacity style={styles.editButtonCircle} onPress={onEditName}>
                <Ionicons name="pencil-outline" size={16} color="#0B1A33" />
              </TouchableOpacity>
            </View>
          )}
          ...
          <Text style={[styles.eventButtonCountLabel, expired && styles.eventButtonCountLabelExpired]}>סה"כ לחיצות</Text>
